...
app.layout =html.Div([
                ...
                html.Div([
                    ...
                    html.Div([
                        html.Div([
                            html.A([
                                html.Img(src='assets/Logos/LOGO1.png', className="image")
                        ...
                        dbc.Row([
                            html.Div([
                                dbc.Col([
                                    html.H1('Dig deep in Data', style = {'color':'white'}),
                                    dbc.Label("Select Column to View data(default Root value - Country)", className= 'heading'),
                                    dcc.Dropdown(id='select_columns',
                                        placeholder='Select type ',
                                        options=[{'label': i, 'value': i} for i in columns],
                                        value=['Year', 'Country', 'Axis of intervention'],
                                        multi=True,
                                        ),
                                ], className = 'dropdown'),
                                dbc.Col([
    ...
    ########################################################################
                        ...
                        dbc.Row([
                            ...
                            ], sm=12, md=6, lg=6, className = 'mini_container'),
                            ...
                            dbc.Col([
                                html.Div([
                                    ...
                                    dbc.Alert(
                                        "All is just consolidated data of three years",
                                        id="alert-auto",
                                        is_open=True,
                                        duration=5000,),
        ...
        #################################################################################
                        ...
                        dbc.Row([
                            ...
                            ], sm=11, md=11, lg=6, className =  'mini_container adjust'),
                            dbc.Col([
                                dcc.Loading(
                                    id="loading-3",
                                    type="default",
                            ...
                            ], sm=11, md=11, lg=6, className =  'mini_container'),
                            dbc.Col([
                                dcc.Loading(
                                    id="loading-4",
                                    type="default",
                            ...
                            ],sm=11, md=11, lg=8, className =  'mini_container')
                        ], justify="center"),
                    ], className= 'dashboard'),
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                html.Div([
                                    ...
                                    html.P("Health, Education, Emergency, Protection")
                                ], className = 'heading mini_container animated fadeInLeft'),
                            ...
                            ], sm=12, md=12, lg=6,xl=5, className =  'mini_container'),
                        ], justify="center"),
                        dbc.Row([
                            dbc.Col([
                                html.Div([
                            ...
                            ], sm=12, md=11, lg=5, xl=5, className = ''),
                            dbc.Col([
                                dcc.Loading(
                                    id="loading-6",
                                    type="default",
                            ...
                            ], sm=12, md=11, lg=5, xl=5, className = 'mini_container')
                        ], justify="center"),
                    ], className = 'partners'),
                    dbc.Row([
                        dbc.Col([
                    ...
                    ],justify='center', className = 'footer')
                ], className= "body")
...
def sunburst_plot(clickData, column_values):
    if len(column_values) == 0:
        column_values = ['Country']
    fig = px.sunburst(df,
                        path=column_values,
                        values='Voted Year project budget €',
                        maxdepth=3,
                        color_discrete_sequence=px.colors.qualitative.Pastel,
                        hover_name='Voted Year project budget €'
